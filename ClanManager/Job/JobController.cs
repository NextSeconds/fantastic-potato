...
namespace ClanManager.Job
{
    ...
    public class JobController
    {
        ...
        public async Task<BaseResult> StopJob(JobKey job)
        {
        ...
        /// </summary> 
        /// <returns></returns>
        public async Task<BaseResult> RemoveJob(JobKey job)
        {
        ...
        /// </summary> 
        /// <returns></returns>
        public async Task<BaseResult> ResumeJob(JobKey job)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<ScheduleEntity> QueryJob(JobKey job)
        {
        ...
        /// <param name="entity"></param>
        /// <returns></returns>
        public async Task<BaseResult> ModifyJob(ScheduleEntity entity)
        {
        ...
        /// <returns></returns>
        public async Task<bool> TriggerJob(JobKey job)
        {
        ...
        /// <returns></returns>
        public async Task<List<string>> GetJobLogs(JobKey jobKey)
        {
        ...
        /// <param name="jobKey"></param>
        /// <returns></returns>
        public async Task<bool> RemoveErrLog(JobKey jobKey)
        {
