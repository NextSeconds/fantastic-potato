...
namespace ClanManager.Job
{
    ...
    public class SchedulerCenter
    {
        ...
        /// <returns></returns>
        public async Task<bool> CheckExistsJobAsync(string jobGroup, string jobName)
        {
            return await Scheduler.CheckExists(new JobKey(jobGroup, jobName));
        }
        ...
        /// <summary>
        /// 强制停止所有任务调度（不可再次重启，一般在程序彻底关闭时调用）
        /// </summary>
